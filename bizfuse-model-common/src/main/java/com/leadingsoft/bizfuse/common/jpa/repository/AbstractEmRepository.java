package com.leadingsoft.bizfuse.common.jpa.repository;
 ...
 * @author liuyg
 */
public abstract class AbstractEmRepository {
    ...
    public AbstractEmRepository(EntityManager em) {
    	this.em = em;
    }
    ...
    public void init() {
        ...
        this.path = AbstractEmRepository.DEFAULT_ENTITY_PATH_RESOLVER.createPath(this.getModelClass());
